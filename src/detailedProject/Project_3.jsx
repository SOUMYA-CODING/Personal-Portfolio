                ...
                <div className="project-details-wrapper">
                    <div className='container'>
                        ...
                        <section className='mb-5'>
                            <h3 className="header-title">Airbnb website clone</h3>
                        ...
                        <section className='project-image mb-5'>
                            <img src="assets/project-3/airbnb_project-2.png" alt="" />
                        </section>
                        ...
                        <section className='project-description mb-5'>
                            ...
                            <section>
                                <img src="assets/project-3/airbnb_project-4.png" alt="" className='image' />
                            </section>
                        </section>

                        {/* Design */}
                        <section className='project-design mb-5'>
                            <h3 className="header-title mb-3 text-center">API Design</h3>
                            <img src="assets/project-3/airbnb_project-3.png" alt="" />
                        </section>
                    </div>
                </div>
            </section>
